 ...
 * RobotDrive's
 * mecanumDrive_Cartesian(double, double, double, double) if a deadband of 0 is
 * used, and the ySpeed
 * and gyroAngle values are inverted compared to RobotDrive (eg
 * driveCartesian(xSpeed, -ySpeed,
...
public class DevilDrive extends RobotDriveBase implements Sendable, AutoCloseable {
    ...
    private final double m_maxOutput = 5676 / 10 * 62.5;
